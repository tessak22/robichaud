...
define('PAGE_PRACTICE_AREAS', 10);
define('PAGE_OUR_FIRM', 11);
define('PAGE_OUR_ATTORNEYS', 12);
define('PAGE_BLOG', 13);
define('PAGE_CONTACT_US', 14);
define('PAGE_CONTACT_MN', 29);
define('PAGE_CONTACT_KY', 30);
define('PAGE_CONTACT_VIETNAM', 31);
define('PAGE_LEGAL_DISCLAIMER', 167);
define('PAGE_PRIVACY_POLICY', 168);
...
function custom_enqueue_scripts() {
    ...
    wp_enqueue_script('modernizer-js', 'https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js', array(), '2.8.3');
...
{
    add_editor_style('css/style-editor-04.css'); // cached, update revision as needed
}
